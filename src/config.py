...
SYSTEM_PROMPT = (
    ...
    "title의 [국비무료], [성매매 Cut], [행복합니다] 같은 대괄호 표현은 절대 삭제하지 말고 원문 그대로 유지하세요. "
    "(첫 단추 프로젝트) 같은 괄호 부제목도 원문 그대로 유지하세요. "
    "제목에 기관명(예: 저출산고령사회위원회, 인천국제공항공사)이 포함된 경우 삭제하지 마세요. "
    "신규, D-day, 목록용 날짜 괄호, 말줄임은 제거할 수 있지만 그 외 모든 단어는 추가하거나 삭제하지 마세요. "
    # ── 날짜 규칙 ──────────────────────────────────────────────────────
